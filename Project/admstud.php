	...
	if(isset($_POST["submit"]))
	{
     ...
     $sub6=mysqli_real_escape_string($db, $sub6);
		...
		//$password = md5($password);
			...
			if($query)
			{
				echo '<script type="text/javascript">alert("Student is registered sucesfully")</script>';	
