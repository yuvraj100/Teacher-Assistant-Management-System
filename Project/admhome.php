...
<div class="wrap">
  <header>
    <div class="container">
      <h1><a href="#">ADMIN Homepage</a></h1>
      <nav>
        <ul>
          <li><a href="admstud.php" class="m1">ADD STUDENT</a></li>
          <li class="current"><a href="admteacher.php" class="m2">ADD TEACHER</a></li>
          <li><a href="delstud.php" class="m3">DELETE STUDENT</a></li>
          <li><a href="delteac.php" class="m4">DELETE TEACHERS</a></li>
		  <li><a href="studentdetails.php" class="m4">SEE STUDENT DETAILS</a></li>
  ...
  <div class="container">
    <aside>
      ...
      <ul class="categories">
        ...
        <li><span><a href="http://www.cusat.ac.in/academic_calendar.php"> ACADEMIC CALENDER</a></span></li>
		<li class="last"><span><a href="start2.php" class="m5">LOGOUT</a></span></li>
      </ul>
    ...
    <section id="content">
      <div id="banner">
        <h2>TEACHERS ASSITANT <span>ONLINE ATTENDANCE <span>WELCOME ADMIN</span></span></h2>
      </div>
      <div class="inside">
