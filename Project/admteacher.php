	...
	if(isset($_POST["submit"]))
	{
	 ...
	 $class=$_POST["class"];
		...
		//$password = md5($password);
	 	...
	 	$query="INSERT INTO  teacher(name, username, department, age, contact,subject, password,class) VALUES ('$name','$username','$department','$age','$contact','$sub','$password','$class');INSERT INTO subject(subject,name,class)VALUES('$sub','$name','$class')";
			...
			if($query)
			{
				echo '<script type="text/javascript">alert("Teacher is registered sucesfully")</script>';
			}
		}
